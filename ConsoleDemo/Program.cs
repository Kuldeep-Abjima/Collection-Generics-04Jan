...
//    {
//     colWidths[colIndex] =  Math.Min(item.ToString().Length, colWidths[colIndex] );
//        colIndex = (colIndex + 1) % columnsCount;
//    }
//    return colWidths;
//}

//IEnumerable<string> FormatGridRows(IEnumerable<Worker> data, int[] colWidhts)
//{
//    StringBuilder row = new();
//    int colIndex = 0;
//    foreach(Worker item in data)
//    {
//        row.Append(item.ToString().PadRight(colWidhts[colIndex] + 2));
//        colIndex = (colIndex + 1) % colWidhts.Length;
//        if (colIndex == 0)
//        {
